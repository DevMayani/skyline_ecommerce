...
useEffect(() => {
  ...
  <div className="flex justify-between items-center pb-10">
    ...
    <Link href={`/bestsellingproductpage`} className="flex justify-center mt-6">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-4 transition-all duration-300">
